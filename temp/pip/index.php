...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta property="og:url" content="https://pypi.org/search/?q=django">
    ...
    <script async
            ...
            src="/static/js/warehouse.deaaafda.js">
    </script>
        ...
        <div class="split-layout">
          ...
          <div class="split-layout">
            ...
            <form class="search-form search-form--primary" action="/search/" role="search">
              ...
              <input id="search" class="search-form__search" type="text" name="q" placeholder="Search projects" value="django" autocomplete="off" autocapitalize="off" spellcheck="false" data-controller="search-focus" data-action="keydown@window->search-focus#focusSearchField" data-target="search-focus.searchField">
  ...
  <nav class="dropdown dropdown--on-menu hidden show-on-tablet" aria-label="Main navigation">
    ...
    <div class="mobile-search">
      <form class="search-form search-form--fullwidth" action="/search/" role="search">
        ...
        <input id="mobile-search" class="search-form__search" type="text" name="q" placeholder="Search projects" value="django" autocomplete="off" autocapitalize="off" spellcheck="false">
        <input type="hidden" name="o" value="">
        <button type="submit" class="search-form__button">
          <i class="fa fa-search" aria-hidden="true"></i>
          <span class="sr-only">Search</span>
...
<div class="horizontal-section horizontal-section--medium">
    ...
    <div class="left-layout__sidebar">
      ...
      <div class="filter-panel -js-filter-panel">
        ...
        <h2 class="no-top-padding">
          Filter by <a href="/classifiers/">classifier</a>
        </h2>
        <form id="classifiers">
        <input id="search" type="hidden" name="q" value="django">
        <input type="hidden" name="o" value="">
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._AWS_CDK" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: AWS CDK" >
    <label class="checkbox-tree__label" for="Framework_._AWS_CDK">AWS CDK</label>
    <ul>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._AWS_CDK_._1" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: AWS CDK :: 1" >
    <label class="checkbox-tree__label" for="Framework_._AWS_CDK_._1">1</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._AWS_CDK_._2" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: AWS CDK :: 2" >
    <label class="checkbox-tree__label" for="Framework_._AWS_CDK_._2">2</label>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Ansible" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Ansible" >
    <label class="checkbox-tree__label" for="Framework_._Ansible">Ansible</label>
  </li>
  
  
  
  <li>
    <input name="c" type="checkbox" id="Framework_._AnyIO" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: AnyIO" >
    <label class="checkbox-tree__label" for="Framework_._AnyIO">AnyIO</label>
  </li>
  
  
  
  <li>
    <input name="c" type="checkbox" id="Framework_._Apache_Airflow" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Apache Airflow" >
    <label class="checkbox-tree__label" for="Framework_._Apache_Airflow">Apache Airflow</label>
    <ul>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Apache_Airflow_._Provider" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Apache Airflow :: Provider" >
    <label class="checkbox-tree__label" for="Framework_._Apache_Airflow_._Provider">Provider</label>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Celery" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Celery" >
    <label class="checkbox-tree__label" for="Framework_._Celery">Celery</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Datasette" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Datasette" >
    <label class="checkbox-tree__label" for="Framework_._Datasette">Datasette</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Django_._1" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Django :: 1" >
    <label class="checkbox-tree__label" for="Framework_._Django_._1">1</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Django_._2" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Django :: 2" >
    <label class="checkbox-tree__label" for="Framework_._Django_._2">2</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Django_._3" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Django :: 3" >
    <label class="checkbox-tree__label" for="Framework_._Django_._3">3</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Django_._3.1" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Django :: 3.1" >
    <label class="checkbox-tree__label" for="Framework_._Django_._3.1">3.1</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Django_._3.2" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Django :: 3.2" >
    <label class="checkbox-tree__label" for="Framework_._Django_._3.2">3.2</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Django_._4" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Django :: 4" >
    <label class="checkbox-tree__label" for="Framework_._Django_._4">4</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Django_._4.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Django :: 4.0" >
    <label class="checkbox-tree__label" for="Framework_._Django_._4.0">4.0</label>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Django_CMS_._3.8" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Django CMS :: 3.8" >
    <label class="checkbox-tree__label" for="Framework_._Django_CMS_._3.8">3.8</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Django_CMS_._3.9" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Django CMS :: 3.9" >
    <label class="checkbox-tree__label" for="Framework_._Django_CMS_._3.9">3.9</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Django_CMS_._3.10" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Django CMS :: 3.10" >
    <label class="checkbox-tree__label" for="Framework_._Django_CMS_._3.10">3.10</label>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._FastAPI" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: FastAPI" >
    <label class="checkbox-tree__label" for="Framework_._FastAPI">FastAPI</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Jupyter_._JupyterLab" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Jupyter :: JupyterLab" >
    <label class="checkbox-tree__label" for="Framework_._Jupyter_._JupyterLab">JupyterLab</label>
    <ul>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Jupyter_._JupyterLab_._1" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Jupyter :: JupyterLab :: 1" >
    <label class="checkbox-tree__label" for="Framework_._Jupyter_._JupyterLab_._1">1</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Jupyter_._JupyterLab_._2" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Jupyter :: JupyterLab :: 2" >
    <label class="checkbox-tree__label" for="Framework_._Jupyter_._JupyterLab_._2">2</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Jupyter_._JupyterLab_._3" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Jupyter :: JupyterLab :: 3" >
    <label class="checkbox-tree__label" for="Framework_._Jupyter_._JupyterLab_._3">3</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Jupyter_._JupyterLab_._4" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Jupyter :: JupyterLab :: 4" >
    <label class="checkbox-tree__label" for="Framework_._Jupyter_._JupyterLab_._4">4</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Jupyter_._JupyterLab_._Extensions" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Jupyter :: JupyterLab :: Extensions" >
    <label class="checkbox-tree__label" for="Framework_._Jupyter_._JupyterLab_._Extensions">Extensions</label>
    <ul>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Jupyter_._JupyterLab_._Extensions_._Mime_Renderers" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Jupyter :: JupyterLab :: Extensions :: Mime Renderers" >
    <label class="checkbox-tree__label" for="Framework_._Jupyter_._JupyterLab_._Extensions_._Mime_Renderers">Mime Renderers</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Jupyter_._JupyterLab_._Extensions_._Prebuilt" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Jupyter :: JupyterLab :: Extensions :: Prebuilt" >
    <label class="checkbox-tree__label" for="Framework_._Jupyter_._JupyterLab_._Extensions_._Prebuilt">Prebuilt</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Jupyter_._JupyterLab_._Extensions_._Themes" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Jupyter :: JupyterLab :: Extensions :: Themes" >
    <label class="checkbox-tree__label" for="Framework_._Jupyter_._JupyterLab_._Extensions_._Themes">Themes</label>
  </li></ul>
  </li></ul>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Kedro" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Kedro" >
    <label class="checkbox-tree__label" for="Framework_._Kedro">Kedro</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Matplotlib" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Matplotlib" >
    <label class="checkbox-tree__label" for="Framework_._Matplotlib">Matplotlib</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Odoo_._8.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Odoo :: 8.0" >
    <label class="checkbox-tree__label" for="Framework_._Odoo_._8.0">8.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Odoo_._9.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Odoo :: 9.0" >
    <label class="checkbox-tree__label" for="Framework_._Odoo_._9.0">9.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Odoo_._10.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Odoo :: 10.0" >
    <label class="checkbox-tree__label" for="Framework_._Odoo_._10.0">10.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Odoo_._11.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Odoo :: 11.0" >
    <label class="checkbox-tree__label" for="Framework_._Odoo_._11.0">11.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Odoo_._12.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Odoo :: 12.0" >
    <label class="checkbox-tree__label" for="Framework_._Odoo_._12.0">12.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Odoo_._13.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Odoo :: 13.0" >
    <label class="checkbox-tree__label" for="Framework_._Odoo_._13.0">13.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Odoo_._14.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Odoo :: 14.0" >
    <label class="checkbox-tree__label" for="Framework_._Odoo_._14.0">14.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Odoo_._15.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Odoo :: 15.0" >
    <label class="checkbox-tree__label" for="Framework_._Odoo_._15.0">15.0</label>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Plone_._6.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Plone :: 6.0" >
    <label class="checkbox-tree__label" for="Framework_._Plone_._6.0">6.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._Zope_._5" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: Zope :: 5" >
    <label class="checkbox-tree__label" for="Framework_._Zope_._5">5</label>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Framework_._aiohttp" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: aiohttp" >
    <label class="checkbox-tree__label" for="Framework_._aiohttp">aiohttp</label>
  </li>
  
  
  
  <li>
    <input name="c" type="checkbox" id="Framework_._cocotb" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: cocotb" >
    <label class="checkbox-tree__label" for="Framework_._cocotb">cocotb</label>
  </li>
  
  
  
  <li>
    <input name="c" type="checkbox" id="Framework_._napari" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Framework :: napari" >
    <label class="checkbox-tree__label" for="Framework_._napari">napari</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._Communications_._Chat_._ICQ" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: Communications :: Chat :: ICQ" >
    <label class="checkbox-tree__label" for="Topic_._Communications_._Chat_._ICQ">ICQ</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._Communications_._Chat_._Unix_Talk" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: Communications :: Chat :: Unix Talk" >
    <label class="checkbox-tree__label" for="Topic_._Communications_._Chat_._Unix_Talk">Unix Talk</label>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._Communications_._FIDO" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: Communications :: FIDO" >
    <label class="checkbox-tree__label" for="Topic_._Communications_._FIDO">FIDO</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._Desktop_Environment_._Window_Managers_._Applets" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: Desktop Environment :: Window Managers :: Applets" >
    <label class="checkbox-tree__label" for="Topic_._Desktop_Environment_._Window_Managers_._Applets">Applets</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._Desktop_Environment_._Window_Managers_._Blackbox" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: Desktop Environment :: Window Managers :: Blackbox" >
    <label class="checkbox-tree__label" for="Topic_._Desktop_Environment_._Window_Managers_._Blackbox">Blackbox</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._Desktop_Environment_._Window_Managers_._FVWM" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: Desktop Environment :: Window Managers :: FVWM" >
    <label class="checkbox-tree__label" for="Topic_._Desktop_Environment_._Window_Managers_._FVWM">FVWM</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._Scientific/Engineering_._Image_Processing" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: Scientific/Engineering :: Image Processing" >
    <label class="checkbox-tree__label" for="Topic_._Scientific/Engineering_._Image_Processing">Image Processing</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._System_._Hardware_._Universal_Serial_Bus_(USB)" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: System :: Hardware :: Universal Serial Bus (USB)" >
    <label class="checkbox-tree__label" for="Topic_._System_._Hardware_._Universal_Serial_Bus_(USB)">Universal Serial Bus (USB)</label>
    <ul>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._System_._Hardware_._Universal_Serial_Bus_(USB)_._Human_Interface_Device_(HID)" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: System :: Hardware :: Universal Serial Bus (USB) :: Human Interface Device (HID)" >
    <label class="checkbox-tree__label" for="Topic_._System_._Hardware_._Universal_Serial_Bus_(USB)_._Human_Interface_Device_(HID)">Human Interface Device (HID)</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._System_._Hardware_._Universal_Serial_Bus_(USB)_._Mass_Storage" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: System :: Hardware :: Universal Serial Bus (USB) :: Mass Storage" >
    <label class="checkbox-tree__label" for="Topic_._System_._Hardware_._Universal_Serial_Bus_(USB)_._Mass_Storage">Mass Storage</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._System_._Hardware_._Universal_Serial_Bus_(USB)_._Miscellaneous" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: System :: Hardware :: Universal Serial Bus (USB) :: Miscellaneous" >
    <label class="checkbox-tree__label" for="Topic_._System_._Hardware_._Universal_Serial_Bus_(USB)_._Miscellaneous">Miscellaneous</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._System_._Hardware_._Universal_Serial_Bus_(USB)_._Smart_Card" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: System :: Hardware :: Universal Serial Bus (USB) :: Smart Card" >
    <label class="checkbox-tree__label" for="Topic_._System_._Hardware_._Universal_Serial_Bus_(USB)_._Smart_Card">Smart Card</label>
  </li></ul>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._System_._Systems_Administration_._Authentication/Directory_._NIS" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: System :: Systems Administration :: Authentication/Directory :: NIS" >
    <label class="checkbox-tree__label" for="Topic_._System_._Systems_Administration_._Authentication/Directory_._NIS">NIS</label>
  </li></ul>
  </li></ul>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._Text_Processing_._Markup_._Markdown" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: Text Processing :: Markup :: Markdown" >
    <label class="checkbox-tree__label" for="Topic_._Text_Processing_._Markup_._Markdown">Markdown</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Topic_._Text_Processing_._Markup_._reStructuredText" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Topic :: Text Processing :: Markup :: reStructuredText" >
    <label class="checkbox-tree__label" for="Topic_._Text_Processing_._Markup_._reStructuredText">reStructuredText</label>
  </li></ul>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="License_._Nokia_Open_Source_License_(NOKOS)" class="-js-form-submit-trigger checkbox-tree__checkbox" value="License :: Nokia Open Source License (NOKOS)" >
    <label class="checkbox-tree__label" for="License_._Nokia_Open_Source_License_(NOKOS)">Nokia Open Source License (NOKOS)</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="License_._OSI_Approved_._MIT_No_Attribution_License_(MIT-0)" class="-js-form-submit-trigger checkbox-tree__checkbox" value="License :: OSI Approved :: MIT No Attribution License (MIT-0)" >
    <label class="checkbox-tree__label" for="License_._OSI_Approved_._MIT_No_Attribution_License_(MIT-0)">MIT No Attribution License (MIT-0)</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="License_._OSI_Approved_._Nethack_General_Public_License" class="-js-form-submit-trigger checkbox-tree__checkbox" value="License :: OSI Approved :: Nethack General Public License" >
    <label class="checkbox-tree__label" for="License_._OSI_Approved_._Nethack_General_Public_License">Nethack General Public License</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="License_._OSI_Approved_._The_Unlicense_(Unlicense)" class="-js-form-submit-trigger checkbox-tree__checkbox" value="License :: OSI Approved :: The Unlicense (Unlicense)" >
    <label class="checkbox-tree__label" for="License_._OSI_Approved_._The_Unlicense_(Unlicense)">The Unlicense (Unlicense)</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Programming_Language_._Ada" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Programming Language :: Ada" >
    <label class="checkbox-tree__label" for="Programming_Language_._Ada">Ada</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Programming_Language_._F#" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Programming Language :: F#" >
    <label class="checkbox-tree__label" for="Programming_Language_._F#">F#</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Programming_Language_._Kotlin" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Programming Language :: Kotlin" >
    <label class="checkbox-tree__label" for="Programming_Language_._Kotlin">Kotlin</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Programming_Language_._Python_._3.10" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Programming Language :: Python :: 3.10" >
    <label class="checkbox-tree__label" for="Programming_Language_._Python_._3.10">3.10</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Programming_Language_._Python_._3.11" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Programming Language :: Python :: 3.11" >
    <label class="checkbox-tree__label" for="Programming_Language_._Python_._3.11">3.11</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Operating_System_._RISC_OS" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Operating System :: RISC OS" >
    <label class="checkbox-tree__label" for="Operating_System_._RISC_OS">RISC OS</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU" >
    <label class="checkbox-tree__label" for="Environment_._GPU">GPU</label>
    <ul>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA">NVIDIA CUDA</label>
    <ul>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._9.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 9.0" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._9.0">9.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._9.2" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 9.2" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._9.2">9.2</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._10.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 10.0" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._10.0">10.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._10.1" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 10.1" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._10.1">10.1</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._10.2" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 10.2" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._10.2">10.2</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._11.0" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 11.0" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._11.0">11.0</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._11.1" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 11.1" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._11.1">11.1</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._11.2" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 11.2" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._11.2">11.2</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._11.3" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 11.3" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._11.3">11.3</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._11.4" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 11.4" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._11.4">11.4</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Environment_._GPU_._NVIDIA_CUDA_._11.5" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Environment :: GPU :: NVIDIA CUDA :: 11.5" >
    <label class="checkbox-tree__label" for="Environment_._GPU_._NVIDIA_CUDA_._11.5">11.5</label>
  </li></ul>
  </li></ul>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Natural_Language_._Basque" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Natural Language :: Basque" >
    <label class="checkbox-tree__label" for="Natural_Language_._Basque">Basque</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Natural_Language_._Irish" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Natural Language :: Irish" >
    <label class="checkbox-tree__label" for="Natural_Language_._Irish">Irish</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Natural_Language_._Lithuanian" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Natural Language :: Lithuanian" >
    <label class="checkbox-tree__label" for="Natural_Language_._Lithuanian">Lithuanian</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Natural_Language_._Nepali" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Natural Language :: Nepali" >
    <label class="checkbox-tree__label" for="Natural_Language_._Nepali">Nepali</label>
  </li>
  ...
  <li>
    <input name="c" type="checkbox" id="Typing_._Stubs_Only" class="-js-form-submit-trigger checkbox-tree__checkbox" value="Typing :: Stubs Only" >
    <label class="checkbox-tree__label" for="Typing_._Stubs_Only">Stubs Only</label>
  </li>
      ...
      <form action="/search/">
        ...
        <div>
          ...
          <ul class="unstyled" aria-label="Search results">
              ...
              <li>
  <a class="package-snippet" href="/project/django-503/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-503</span>
      <span class="package-snippet__version">0.1</span>
      <span class="package-snippet__released"><time datetime="2011-10-03T19:23:17+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Oct 3, 2011
</time></span>
    </h3>
    <p class="package-snippet__description">An app to show 503 error page, while your django site is on maintenance.</p>
  </a>
</li>
  ...
  <a class="package-snippet" href="/project/django/">
    <h3 class="package-snippet__title">
      ...
      <span class="package-snippet__version">4.0.4</span>
      <span class="package-snippet__released"><time datetime="2022-04-11T07:53:01+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Apr 11, 2022
</time></span>
    </h3>
    <p class="package-snippet__description">A high-level Python web framework that encourages rapid development and clean, pragmatic design.</p>
              ...
              <li>
  <a class="package-snippet" href="/project/django-scribbler-django2-0/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-scribbler-django2.0</span>
      <span class="package-snippet__version">0.9.3</span>
      <span class="package-snippet__released"><time datetime="2018-10-28T00:33:44+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Oct 28, 2018
</time></span>
    </h3>
    <p class="package-snippet__description">django-scribbler is an application for managing snippets of text for a Django website.</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-filebrowser-django13/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-filebrowser-django13</span>
      <span class="package-snippet__version">3.0</span>
      <span class="package-snippet__released"><time datetime="2011-03-14T18:07:02+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Mar 14, 2011
</time></span>
    </h3>
    <p class="package-snippet__description">Media-Management with the Django Admin-Interface. Package for using without django-grapelli in Django 1.3</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-tracking-analyzer-django2/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-tracking-analyzer-django2</span>
      <span class="package-snippet__version">0.3</span>
      <span class="package-snippet__released"><time datetime="2019-01-02T13:38:18+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Jan 2, 2019
</time></span>
    </h3>
    <p class="package-snippet__description">User actions tracking and analytics for Django sites.</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-suit-redactor-django2/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-suit-redactor-django2</span>
      <span class="package-snippet__version">0.5.1</span>
      <span class="package-snippet__released"><time datetime="2020-02-19T18:39:04+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Feb 19, 2020
</time></span>
    </h3>
    <p class="package-snippet__description">Imperavi Redactor (WYSIWYG editor) integration app for Django admin. http://imperavi.com/redactor/</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-django-csv-exports/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-django_csv_exports</span>
      <span class="package-snippet__version">1.0.0</span>
      <span class="package-snippet__released"><time datetime="2015-07-10T14:54:52+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Jul 10, 2015
</time></span>
    </h3>
    <p class="package-snippet__description">&lt;Include a description of your project&gt;</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-jchart-django3-uvm/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-jchart-django3-uvm</span>
      <span class="package-snippet__version">0.4.2</span>
      <span class="package-snippet__released"><time datetime="2020-02-05T15:21:13+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Feb 5, 2020
</time></span>
    </h3>
    <p class="package-snippet__description">A Django App to plot charts using the excellent Chart.JS library. Updated for Django 3.x compatibility</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-totalsum-admin-django3/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-totalsum-admin-django3</span>
      <span class="package-snippet__version">1.0.0</span>
      <span class="package-snippet__released"><time datetime="2020-01-08T01:30:01+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Jan 8, 2020
</time></span>
    </h3>
    <p class="package-snippet__description">A django app that initializes admin changelist view with last row in results as sum of some numerical fields or properties</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-debug-toolbar-django13/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-debug-toolbar-django13</span>
      <span class="package-snippet__version">0.8.4</span>
      <span class="package-snippet__released"><time datetime="2011-03-14T16:53:29+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Mar 14, 2011
</time></span>
    </h3>
    <p class="package-snippet__description">A configurable set of panels that display various debug information about the current request/response. Version fully Django 1.3 compatible</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-thumborize/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-thumborize</span>
      <span class="package-snippet__version">1.0</span>
      <span class="package-snippet__released"><time datetime="2014-10-21T03:00:17+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Oct 21, 2014
</time></span>
    </h3>
    <p class="package-snippet__description">Minimal interface for thumbor imaging service</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-lgi/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-lgi</span>
      <span class="package-snippet__version">0.1.2</span>
      <span class="package-snippet__released"><time datetime="2020-07-07T20:16:32+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Jul 7, 2020
</time></span>
    </h3>
    <p class="package-snippet__description">Django Lambda Gateway Interface</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/ng2django/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">ng2django</span>
      <span class="package-snippet__version">20.7.13</span>
      <span class="package-snippet__released"><time datetime="2020-07-14T03:32:08+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Jul 14, 2020
</time></span>
    </h3>
    <p class="package-snippet__description">Convert your Angular built index.html file to Django Template syntax</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-ssr/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-ssr</span>
      <span class="package-snippet__version">0.0.1</span>
      <span class="package-snippet__released"><time datetime="2018-07-02T12:15:41+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Jul 2, 2018
</time></span>
    </h3>
    <p class="package-snippet__description">SSR for django project</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-blogs/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-blogs</span>
      <span class="package-snippet__version">0.2.0</span>
      <span class="package-snippet__released"><time datetime="2012-11-18T07:05:06+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Nov 18, 2012
</time></span>
    </h3>
    <p class="package-snippet__description">Django blogs - module that provide blogs to your django application.
- One user blog
- Multi blogging system
- Blog per user
- Safe html in posts
- System to manage permissions to read\write\moderate blogs</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-paybills/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-paybills</span>
      <span class="package-snippet__version">1.0.0</span>
      <span class="package-snippet__released"><time datetime="2019-05-10T20:59:18+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  May 10, 2019
</time></span>
    </h3>
    <p class="package-snippet__description">Django app for paypal integration.</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-cast/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-cast</span>
      <span class="package-snippet__version">0.1.35</span>
      <span class="package-snippet__released"><time datetime="2020-10-26T05:35:17+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Oct 26, 2020
</time></span>
    </h3>
    <p class="package-snippet__description">Just another blogging / podcasting package</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-polyfield/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-polyfield</span>
      <span class="package-snippet__version">0.1.0</span>
      <span class="package-snippet__released"><time datetime="2017-05-21T15:25:49+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  May 21, 2017
</time></span>
    </h3>
    <p class="package-snippet__description">Django Polyfield</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-activitysync/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-activitysync</span>
      <span class="package-snippet__version">0.2.2</span>
      <span class="package-snippet__released"><time datetime="2011-02-14T07:31:44+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Feb 14, 2011
</time></span>
    </h3>
    <p class="package-snippet__description">Fast, easy, and extensible social activity aggregation for Django projects</p>
  </a>
</li>
            
              <li>
  <a class="package-snippet" href="/project/django-inviter/">
    <h3 class="package-snippet__title">
      <span class="package-snippet__name">django-inviter</span>
      <span class="package-snippet__version">0.2.4</span>
      <span class="package-snippet__released"><time datetime="2012-03-28T14:50:21+0000" data-controller="localized-time" data-localized-time-relative="true" data-localized-time-show-time="false">
  Mar 28, 2012
</time></span>
    </h3>
    <p class="package-snippet__description">Invite users to your Django apps</p>
  </a>
</li>
...
<div class="button-group button-group--pagination">
  ...
  <a class="button button-group__button button--disabled">Previous</a>
    ...
    <a href="/search/?q=django&amp;page=2" class="button button-group__button">2</a>
    
    
    
    <a href="/search/?q=django&amp;page=3" class="button button-group__button">3</a>
    ...
    <a href="/search/?q=django&amp;page=500" class="button button-group__button">500</a>
    

    
    
    <a href="/search/?q=django&amp;page=2" class="button button-group__button">Next</a>
